...
#   test "1",meta do
#     # IO.inspect BattleCore.summon_card(Yugioh.Data.Cards.get(12),0,:defense_down,meta[:battle_data])
#     # IO.inspect BattleCore.get_handcard_special_summon_operations 11,battle_info = meta[:battle_info]
#     IO.inspect BattleCore.get_handcard_operations(Yugioh.Data.Cards.get(11),meta[:battle_data])
#   end
