defmodule GetCardsCoreTest do
  ...
  test "get cards test" do
    player_battle_info = BattlePlayerInfo[id: 6,graveyardcards: [1,2,3,4,5],player_pid: self]
    ...
    {result,battle_data1} = GetCardsCore.get_cards_of_scene 6,6,:graveyard_zone,battle_data
    assert result == :ok
    assert battle_data1 == battle_data
    receive do
      {:send,message}->
        assert message == <<0, 31, 46, 234, 0, 0, 0, 6, 3, 0, 5, 0, 0, 0, 1, 0, 0, 0, 2, 0, 0, 0, 3, 0, 0, 0, 4, 0, 0, 0, 5>>
    end
